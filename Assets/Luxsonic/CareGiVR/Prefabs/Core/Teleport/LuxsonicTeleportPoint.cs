...
namespace Caregivr
{
	...
	public class LuxsonicTeleportPoint : LuxTeleportMarkerBase
	{
		...
		public override void Highlight( bool highlight )
		{
			if ( !locked )
			{
				if ( highlight )
				{
					SetMeshMaterials( LuxTeleport2.instance.pointHighlightedMaterial, titleHighlightedColor );
				}
				else
				{
					SetMeshMaterials( LuxTeleport2.instance.pointVisibleMaterial, titleVisibleColor );
				}
			}
		...
		public override void UpdateVisuals()
		{
			...
			if ( locked )
			{
				SetMeshMaterials( LuxTeleport2.instance.pointLockedMaterial, titleLockedColor );
		...
		public void UpdateVisualsInEditor()
		{
			...
			if ( locked )
			{
				...
				markerMesh.sharedMaterial = LuxTeleport2.instance.pointLockedMaterial;
				lockedIcon.sharedMaterial = LuxTeleport2.instance.pointLockedMaterial;
			...
			else
			{
				...
				markerMesh.sharedMaterial = LuxTeleport2.instance.pointVisibleMaterial;
				switchSceneIcon.sharedMaterial = LuxTeleport2.instance.pointVisibleMaterial;
				moveLocationIcon.sharedMaterial = LuxTeleport2.instance.pointVisibleMaterial;
...
#if UNITY_EDITOR
	//-------------------------------------------------------------------------
	[CustomEditor( typeof( LuxsonicTeleportPoint ) )]
	public class TeleportPointEditor : Editor
	{
		...
		void OnEnable()
		{
			...
			{
				LuxsonicTeleportPoint teleportPoint = Selection.activeTransform.GetComponent<LuxsonicTeleportPoint>();
